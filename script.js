...
const UI = {
  es:{
    ...
    footerText:"DITLELE S.A. — materiales y equipos para líneas de alta tensión. La cotización se coordina directo con nuestro equipo técnico; este sitio no procesa pagos.",
  ...
  en:{
    ...
    footerText:"DITLELE S.A. — materials and equipment for high-voltage lines. Quotes are coordinated directly with our technical team; this site does not process payments.",
  ...
  zh:{
    ...
    footerText:"DITLELE S.A. —— 高压线路材料与设备供应商。报价由技术团队直接协调；本网站不处理支付。",
    waBtn:"WhatsApp报价",
    wcBtn:"微信报价",
